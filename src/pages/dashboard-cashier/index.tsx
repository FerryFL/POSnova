            ...
            <h1 className="text-xl font-bold mb-4">Dashboard Kasir</h1>
            {
                isCategoriesLoading ? (
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-2 mb-4 w-full">
                        ...
                        <Card className="hover:bg-gray-100 transition-colors p-3 shrink-0 gap-0 min-w-32 max-w-52 text-center flex justify-center items-center cursor-pointer" onClick={() => handleClick("Semua", "Semua")}>
...

                        {
                            categories?.filter((category) => category.status === true).map((category) => (
                                <Card key={category.id} className="hover:bg-gray-100 transition-colors shrink-0 p-3 gap-1 min-w-32 max-w-52 text-center flex justify-center items-center cursor-pointer" onClick={() => handleClick(category.id, category.nama)}>
